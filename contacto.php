                        ...
                        <div class="row">
                            ...
                            <form class="form" id="" action="https://gnutresaqas.sugarondemand.com/index.php?entryPoint=webtocase" method="post"  >
                                <div class="form-group">		    							
                                    ...
                                    <input type="text" class="form-control" id="nombreContacto" name="description[first_name]" placeholder="Nombre de contacto" required>		
                                </div>
                               
                                <div class="form-group">		    							
                                    <label for="ApellidosContacto">Apellidos de contacto</label>
                                    <input type="text" class="form-control" id="apellidosContacto" name="description[last_name]" placeholder="Apellidos de contacto" required>	
                                </div>

                                <div class="form-group col-sm-6">
                                    <label for="TipoID">Tipo de Documento</label>    							
                                    <select class="form-control" id="tipoID" name="tipoID">
                                        <option selected>Cédula de ciudadania</option>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="numID" name="description[contact_cedula]" placeholder="N&uacute;mero de documento" required>			
                                </div>
                                <div class="form-group col-sm-6 col-md-4" >
                                    <label>Pa&iacute;s</label>   												
                                    <div id="pais" name="description[pais]" class="bfh-selectbox bfh-countries" data-country="CO" data-flags="false"></div>
                                </div>					
                                <div class="form-group col-sm-6 col-md-6">
                                    <label>Departamento</label>						
                                    <div id="departamento" class="bfh-selectbox bfh-states" name="description[departamento]" data-country="pais"></div>	
                                </div>
                                <div class="form-group col-sm-6 col-md-5">
                                    <label for="NumCel">N&uacute;mero celular</label>
                                    <input type="text" class="form-control" id="numero_celular" name="description[numero_celular]" placeholder="N&uacute;mero celular">			
                                </div>
                                <div class="form-group col-sm-6 col-md-4">
                                    <label for="email">Correo electr&oacute;nico</label>
                                    <input type="email" class="form-control" id="correo_electronico" name="description[correo_electronico]" placeholder="Correo electr&oacute;nico">			
                                </div>
                                <div class="form-group col-sm-6 col-md-6 radio" id="autorizo">
